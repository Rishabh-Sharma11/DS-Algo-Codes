...
public class LinkedList_K_Append {
	...
	public LinkedList_K_Append() {
		this.head = null;
		this.tail = null;
		this.size = 0;
	}

	public LinkedList_K_Append(Node head, Node tail, int size) {
		this.head = head;
		this.tail = tail;
		this.size = size;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		LinkedList_K_Append list = new LinkedList_K_Append();
